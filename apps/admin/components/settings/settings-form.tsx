...
import type {
  ...
  SettingsCTA,
  SettingsLink,
} from "@joe-kuntani/shared/lib/settings";
import {
  AdminErrorState,
  AdminSkeleton,
  ButtonPending,
    ...
    <form className={styles.form} onSubmit={save}>
      ...
      <nav className={styles.sectionNav} aria-label="Settings sections">
        <a href="#settings-brand">
          <span>01</span>Brand & SEO
        </a>
        <a href="#settings-navigation">
          <span>02</span>Navigation
        </a>
        ...
        {state.can_manage ? (
          <a href="#settings-integrations">
            <span>05</span>Integrations
          </a>
        ) : null}
      </nav>
      <section id="settings-brand">
      ...
      <section id="settings-navigation">
